...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        switch (type) {
            case "Chinese Burger": return new ChineseBurger("Chinese Burger");
            case "American Burger": return new AmericanBurger("American Burger");
            case "Russian Burger": return new RussianBurger("Russian Burger");
            default:
                return null;
        }
    }
